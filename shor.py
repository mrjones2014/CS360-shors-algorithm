# Sample taken from https://github.com/ProjectQ-Framework/ProjectQ/blob/master/examples/shor.py
...
from projectq.backends import Simulator, IBMBackend, ResourceCounter
